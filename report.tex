...
\begin{figure}[!htb]
	...
	ylabel = {Precent of all requests}]
	\addplot[
	color=blue,
	]
	...
	table{./results/redis/SET_pipeline_10_w_10.cdf.results};
	\addplot[
	color=blue,
	]
	table{./results/redis/SET_pipeline_10_w_100.cdf.results};
	\addplot[
	color=blue,
	]
	table{./results/redis/SET_pipeline_10_w_500.cdf.results};
	\addplot[
	color=blue,
	]
	table{./results/redis/SET_pipeline_10_w_1000.cdf.results};
	\addplot[
	color=blue,
	]
	table{./results/redis/SET_pipeline_50_w_10.cdf.results};
	\addplot[
	color=blue,
	]
	table{./results/redis/SET_pipeline_50_w_100.cdf.results};
	\addplot[
	color=blue,
	]
	table{./results/redis/SET_pipeline_50_w_500.cdf.results};
	\addplot[
	color=blue,
	]
	table{./results/redis/SET_pipeline_50_w_1000.cdf.results};
	\addplot[
	color=red,
	]
	...
	table{./results/keyvee/SET_pipeline_10_w_10.cdf.results};
	\addplot[
	color=red,
	]
	table{./results/keyvee/SET_pipeline_10_w_100.cdf.results};
	\addplot[
	color=red,
	]
	table{./results/keyvee/SET_pipeline_10_w_500.cdf.results};
	\addplot[
	color=red,
	]
	table{./results/keyvee/SET_pipeline_10_w_1000.cdf.results};
	\addplot[
	color=red,
	]
	table{./results/keyvee/SET_pipeline_50_w_10.cdf.results};
	\addplot[
	color=red,
	]
	table{./results/keyvee/SET_pipeline_50_w_100.cdf.results};
	\addplot[
	color=red,
	]
	table{./results/keyvee/SET_pipeline_50_w_500.cdf.results};
	\addplot[
	color=red,
	]
	table{./results/keyvee/SET_pipeline_50_w_1000.cdf.results};
	\end{axis}
	\end{tikzpicture}
	\caption{SET Latency. Blue is Redis, red is Keyvee}
\end{figure}

...
legend style={at={(0.5,-0.2)}, anchor=north}]
	...
	\label{fig:MSET_L}
\end{figure}
Compared to SET, MSET is slightly more complex and time consuming command, resulting in lower throughput for both applications, as seen in \ref{fig:MSET_T}.
...
\end{figure}
The GET command is simpler than SET, and so Keyvee's throughput was relatively better when compared to the SET command.
...
legend style={at={(0.5,-0.2)}, anchor=north}]
	...
	\end{axis}
	\end{tikzpicture}
	\caption{PING Latency with a pipeline of 50}
\end{figure}

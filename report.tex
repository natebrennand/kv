...
The Keyvee unikernel implemented Redis's communication protocols so that we could use the same benchmark for all test setups.
...
table{./keyvee/GET_pipeline_10_w_100.cdf.results};
\end{axis}
\end{tikzpicture}
